...
<body>
 ...
 ?>
                         ...
                         <div>
                          <?php  require_once '../../View/login_format.php'; ?>
                            
                         </div>
<?php } else { ?>
                   
                         
                                <a href="index.php?act=login" class="btn btn-sm btn-lightm" type="button">Sign in</a>
                                <a href="index.php?act=register" class="btn btn-sm btn-lightm" type="button">Sign up</a>
                          <?php  } ?>    
                ...
                <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <a href="index.php?act=product" class="nav-item nav-link">Shop</a>
